	...
	<div class="content-wrapper">
		<div class="page-header">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><button data-toggle="modal" data-target="#add" type="button" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i>
							Tambah Data Lokasi</button></li>
				...
				<div class="modal fade" id="edit<?= $value->id_lokasi ?>">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<?php
								echo form_open('ongkir/edit/' . $value->id_lokasi);
								?>
				...
				<div class="modal fade" id="delete<?= $value->id_lokasi ?>">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-footer justify-content-between">
								<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
								<a href="<?= base_url('ongkir/delete/' . $value->id_lokasi) ?> " class="btn btn-primary">Delete</a>
							</div>
						</div>
						<!-- /.modal-content -->
					</div>
