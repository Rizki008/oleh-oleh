				...
				<div class="card">
					<div class="card-body">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="nama_produk" value="<?= $produk->nama_produk ?>" id="exampleInputName1" placeholder="Nama Produk" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="number" class="form-control" name="berat" value="<?= $produk->berat ?>" id="exampleInputPassword4" placeholder="Berat Produk" required>
						</div>
						<div class="form-group">
							<label for="exampleSelectGender">Satuan berat</label>
							<input type="text" class="form-control" name="product_unit" value="<?= $produk->product_unit ?>" placeholder="Satuan Berat" required>
						</div>
						<div class="form-group">
							<label>Harga</label>
							<input type="text" name="harga" class="form-control" value="<?= $produk->harga ?>" placeholder="Harga" required>
						</div>
						<div class="form-group">
							<label for="exampleInputCity1">Stock</label>
							<input type="number" class="form-control" name="stock" value="<?= $produk->stock ?>" id="exampleInputCity1" placeholder="Stock">
						</div>
						<div class="form-group">
